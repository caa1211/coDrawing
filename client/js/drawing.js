...
DrawingPad = function(options) {
    ...
    function setUserList(data) {
        ...
        $(".userList li").click(function() {
            ...
            DP.thisObj.socket.emit('requestShare', {
                senderId: DP.thisObj.id,
                listenerId: $(this).attr("data-id"),
                senderName: DP.myName
    ...
    function createNewClient(data) {
        ...
        if (DP.thisObj.id === data.listenerId && !DP.thisObj[data.senderId]) { //test to see if this instance is the one i want.
            if (confirm(data.senderName + " wants to share their canvas.")) {
                DP.thisObj.socket.emit('confirmShare', {
                    isSharing: true,
                    senderId: data.senderId,
                    listenerId: DP.thisObj.id,
                    senderName: DP.myName
                });
    ...
    function _setEventHandlers() {
        ...
        window.onunload = function(e) {
            DP.thisObj.socket.emit('deleteSharedById', {
                id: DP.thisObj.id
            });
        };
        ...
        $(".toolbar").find(".sprite").click(function() {
            ...
            if ($(this).hasClass(tools[0])) { //share
                ...
                $(".btn-danger").click(function() {
                    ...
                    DP.thisObj.socket.emit("eraseRequestById", {
                        id: DP.thisObj.id
                    });
                });
                $(".alert").show().alert();
    ...
    this.init = function(selector) {
        ...
        $(".confirm").click(function() {
            ...
            DP.thisObj.socket.emit('setClientId', {
                id: id,
                senderName: DP.myName
            });
        });
